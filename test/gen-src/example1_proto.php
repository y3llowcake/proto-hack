...
class AEnum1 {
  ...
  public static function FromInt(int $i): ¡AEnum1_t {
    return $i;
  }
}
...
newtype ¡example1_AEnum2_t as int = int;
class example1_AEnum2 {
  const ¡example1_AEnum2_t C = 0;
  const ¡example1_AEnum2_t D = 10;
  private static dict<int, string> $itos = dict[
    0 => 'C',
    10 => 'D',
  ];
  ...
  public static function FromInt(int $i): ¡example1_AEnum2_t {
    return $i;
  }
}
...
class ¡FileDescriptor_example1__proto implements \Protobuf\Internal\FileDescriptor {
